namespace AcmeCorp.EventSourcing.UnitTests
{
    ...
    public class EventStoreDomainRepositoryLoadFromSnapshotDefaultTests : EventStoreDomainRepositoryLoadFromSnapshotTests
    {
        [Fact]
        ...
        [Fact]
        public async Task Given_An_Aggregate_With_Snapshot_And_One_Event_In_The_Stream_Since_The_Snapshot_Then_The_Number_Of_Events_Since_Last_Snapshot_Is_One_For_Load_From_Latest()
        {
            IDomainRepository domainRepository = GetDomainRepository();
        ...
        [Fact]
        public async Task Given_An_Aggregate_With_Snapshot_And_Three_Events_In_The_Stream_Since_The_Snapshot_Then_The_Number_Of_Events_Since_Last_Snapshot_Is_Three_For_Load_From_Latest()
        {
            IDomainRepository domainRepository = GetDomainRepository();
